...
#➜  cmm_git git:(main) ✗ uv pip install fire
#➜  cmm_git git:(main) ✗ uv pip install colorama
#➜  cmm_git git:(main) ✗ uv run python -m moulinette prepare_exercises          
#➜  cmm_git git:(main) ✗ uv run python -m moulinette grade_student_answers /home/kle-scor/sgoinfre/cmm_git/data/output/to_write.json
